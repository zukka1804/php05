...
<body>
    ...
    <header>
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <button type="button" onclick="location.href='select.php'" class="link_button">データ登録</button><br>
                </div>
            </div>
        </nav>
    </header>
    ...
    <form method="post" action="insert.php">
        <div class="jumbotron">
            <fieldset>
                <h2>
                <legend class="form">遺言書作成フォーム</legend>
                </h2>
                <!-- 遺言者氏名 -->
                <p style="display: inline;">遺言作成者のお名前<input type="text" name="testator_name" class="label" placeholder="例）山田太郎"></p><br>

                <!-- 遺言者住所 -->
                <!-- 本当は郵便番号から住所表示させて、name属性つけたかったけど、各住所項目にそれぞれname付けないといけないのか？？ -->
                <p style="display: inline;">遺言作成者の住所<br><textArea name="testator_address" rows="6" cols="40"  class="fugen" placeholder="例）〒060-0002 北海道札幌市中央区北２条西７丁目 かでる2.7 ４階"></textArea></p><br>
                ...
                <!-- 遺言者の誕生日 -->
                <div>遺言作成者の生年月日
                    <input type="date" name="testator_birth" id="" class="birth">
                </div>
                ...
                <div class="matome">
                    ...
                    <label>渡す相手先の名前<input type="text" name="name1"  placeholder="例）山田花子" class="trust_name"></label><br>
                ...
                <div class="matome">
                    ...
                    <p style="display: inline;">渡す相手先の名前<input type="text" name="name2"  class="trust_name" placeholder="例）佐藤一郎"></p><br>
                    <div style="display: inline-block;">
                            <ul class="box">
                ...
                <div class="matome">
                    ...
                    <p style="display: inline;">渡す相手先の名前<input type="text" name="name3"  class="trust_name" placeholder="例）鈴木和子"></p><br>
                    <div style="display: inline-block;">
                            <ul class="box">
                    ...
                    <h3 class="trust_main">遺言により寄付をする場合に入力してください</h3><br>
                        ...
                        <p style="display: inline;">寄付する金額<input type="text" name="amount"  class="amount" placeholder="例）１００万円"></p><br>
                        <p style="display: inline;">寄付先の正式名称</p><input type="text" name="group_name"  class="group_name" placeholder="例）公益社団法人北海道社会福祉士会"></p><br>
                        <p style="display: inline;">寄付先の住所</p><br>
                        <textArea name="group_address" rows="6" cols="40"  class="fugen" placeholder="例）〒060-0002 北海道札幌市中央区北２条西７丁目 かでる2.7 ４階"></textArea></p><br>
                    </div>
                    <!-- <div class="matome"> -->
                    <p style="display: inline;">遺言に基づく業務をお願いする方（遺言執行者）の名前</p><br>
                    <!-- <label>遺言執行者の名前： -->
                        <input type="text" name="lawyer_name" class="label" placeholder="例）山崎育夫"></label><br>
                    <!-- 遺言執行者住所 -->
                    <p style="display: inline;">遺言執行者の住所</p><br>
                    <textArea name="lawyer_address" rows="6" cols="40"  class="fugen" placeholder="例）〒060-0001 札幌市中央区北1条西10丁目 札幌弁護士会館7F"></textArea></p><br>
                ...
                <div class="address_button">
                    ...
                    <!-- 遺言執行者の生年月日 -->
                    <div>遺言執行者の生年月日
                        <input type="date" name="lawyer_birth" id=""  class="birth">
                    </div>
                    </div>
                    <div class="matome">
                    <!-- 付言事項 -->
                    <p>家族に特に伝えたいこと</p>
                        <div><textArea name="ps" rows="6" cols="80" class="fugen" placeholder="例）家族仲良くこれからも過ごしてほしい。"></textArea></div><br>
                    <!-- <div>家族に特に伝えたいこと：</div>
