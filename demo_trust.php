    ...
    <header>
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <button type="button" onclick="location.href='login.php'" class="link_button">ログイン画面に戻る</button><br>
            </div>
        </nav>
    </header>
    <!-- Head[End] -->
    ...
    <form method="post" action="update.php">
        <div class="jumbotron">
            <fieldset>
                ...
                <label>渡す相手先の名前<input type="text" name="name3"  class="trust_name" placeholder="例）鈴木和子"></label><br>
                <div style="display: inline-block;">
                <ul class="box">
                ...
                <p style="display: inline;">寄付先の正式名称<input type="text" name="group_name"   class="group_name" placeholder="例）公益社団法人北海道社会福祉士会"></p><br>
                <p style="display: inline;">寄付先の住所<br><textArea name="group_address" rows="6" cols="40"  class="fugen" placeholder="例）〒060-0002 北海道札幌市中央区北２条西７丁目 かでる2.7 ４階"></textArea></p><br>

                <p style="display: inline;">遺言に基づく業務をお願いする方（遺言執行者）の名前<br>
                <input type="text" name="lawyer_name"   class="label" placeholder="例）山崎育夫"></p><br>
                <!-- 遺言執行者住所 -->
                <p style="display: inline;">遺言執行者の住所<br><textArea name="lawyer_address" rows="6" cols="40"  class="fugen" placeholder="例）〒060-0001 札幌市中央区北1条西10丁目 札幌弁護士会館7F"></textArea></p><br>
