...
<div class="navbar-header">
  <div class="abc">
    <button type="button" onclick="location.href='index.php'" class="link_button">データ登録</button>
    <button type="button" onclick="location.href='login.php'" class="link_button">別の利用者名でログイン</button>
    ...
    <?php if($flg == 1){echo  'ユーザー管理画面';}?></button>
    </div>
  </div>
